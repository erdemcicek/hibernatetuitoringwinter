...
public class Books05 {
	...
	@ManyToMany(mappedBy="booksList") // When we delete this annotation, Hibernate creates two connection table
	...
	public String toString() {
		return "Books05 [book_id=" + book_id + ", book_name=" + book_name + ", studentList=" + studentList + "]";
	}
