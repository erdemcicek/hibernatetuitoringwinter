...
/*
	...
	Note: If you use a class in hibernate to create table in database, do not make any variable "final" or "static"
...
public class Students01 {
	...
	@Id						  // @Id is used to make a variable primary key in the table
